...
public class ProductDAO {
	...
	// 상품 카테고리별
	private final String SQL_SELECTALL_CATEGORY = "SELECT * FROM PRODUCT WHERE CATEGORY= ? AND PRICE BETWEEN ? AND ? ORDER BY P_NO DESC";
	// 새상품
	private final String SQL_SELECTALL_NEW = "SELECT * FROM PRODUCT WHERE PRICE BETWEEN ? AND ? ORDER BY P_NO DESC";
	// 할인 상품 검색
	...
	// 상품 재고 수량 업데이트
	private final String SQL_UPDATE_STOCK = "UPDATE PRODUCT SET P_SOTCK = P_STOCK - ? WHERE P_NO = ?"; 
	// 상품 삭제
