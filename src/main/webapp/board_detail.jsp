                  ...
                  buttons : [
                        {
                           title : '웹으로 보기',
                           link : {
                              mobileWebUrl : 'http://localhost:8088/NYANGSINSA2/boardPostView.do?boardNum=${board.boardNum}', // 이동할 경로
                              webUrl : 'http://localhost:8088/NYANGSINSA2/boardPostView.do?boardNum=${board.boardNum}', // 이동할 경로
                           },
                        }, ],
