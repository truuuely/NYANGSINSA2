...
<body>
	...
	<br> 제 9 조 (회원의 의무) ① 회원은 서비스 이용 시 다음 각 호의 행위를 하지 않아야 합니다.
	...
	<br> 제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)
	...
	<br>④ 타인 명의로 신청을 하였거나 신청서 내용의 허위 기재 또는 허위서류를 첨부하여 이용계약을 체결한 경우 사이트는 상기 규정에 의하여 해지된 이용고객에 대해서는 별도로 정한 기간동안 가입을 제한할 수 있습니다.
	...
	<br>(시행일) 이 약관은 2015년 01월부터 시행합니다.
</body>
</html>