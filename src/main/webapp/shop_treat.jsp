...
<body>
			...
			<div class="row">
				<div class="col-lg-3 col-md-5">
					<div class="sidebar">
						...
						<div class="sidebar__item">
							<h4>가격 필터</h4>
                            <input type="text" class="input-price" id="minamount">원 &nbsp; &nbsp; - 
                            <input type="text" class="input-price" id="maxamount">원<br>
                            <div class="price-range-wrap">
                                ...
                                <div class="range-slider">
                                  <div style="text-align:center"><button class="button-price" type="button" onclick="javascript:setPrice()">가격 필터 적용하기</button></div>
                                </div>
							</div>
                        </div>
						<!-- 가격 필터 슬라이드 바 부분 -->
						...
						<div class="row">
							<div class="col-lg-4 col-md-5">
								<div class="filter__sort">
									<span>정렬</span> <select id="sort"
										onchange="javascript:setSort()">
	...
	<script>
		$(document).ready(function() {
			list("treat", "sellDesc", 1, 0, 100000);
