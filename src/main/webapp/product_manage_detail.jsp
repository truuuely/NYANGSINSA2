		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					...
					<!-- Cards -->
					<li class="menu-item"><a href="member_manage.jsp" class="menu-link"> <i class="menu-icon tf-icons bx bx-user-check"></i>
							<div data-i18n="Basic">회원관리</div>
					</a></li>

					<!-- 상품관리 -->
					<li class="menu-item"><a href="product_manage.jsp" class="menu-link"> <i class="menu-icon tf-icons bx bx-store"></i>

							<div data-i18n="Basic">상품관리</div>
					</a></li>

					<!-- 주문관리 -->
					<li class="menu-item"><a href="order_manage.jsp" class="menu-link"> <i class="menu-icon tf-icons bx bx-receipt"></i>
							<div data-i18n="Basic">주문관리</div>
					</a></li>

					<!-- 리뷰관리 -->
					<li class="menu-item"><a href="review_manage.jsp" class="menu-link"> <i class="menu-icon tf-icons bx bx-message-alt-dots"></i>
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<form action="updateProduct.do" method="POST" enctype="multipart/form-data">
							...
							<div class="card  mb-4">
								...
								<div class="card-body">
									<div class="mb-3">
										<label for="formFileMultiple" class="form-label">이미지 파일을 선택하세요</label> <input class="form-control" type="file" id="formFileMultiple" name="img" accept="image/*" multiple />
									</div>
								</div>
							</div>
							...
							<div class="card  mb-4">
								...
								<div class="card-body">
									<div class="mb-3">
										<label for="formFileMultiple" class="form-label">이미지 파일을 선택하세요 2</label> <input class="form-control" type="file" id="formFileMultiple2" name="img2" accept="image/*" multiple />
									</div>
								</div>
							</div>
