...
<body>
   ...
   <section class="shoping-cart spad">
      <div class="container">
         <div class="row">
            <div class="col-lg-12">
               <div class="shoping__cart__table">
                  <div id="dataTableBody" style="text-align: center;"></div>
               </div>
            </div>
         </div>
         ...
         <div class="jss8074">
            <div class="jss8099">
               <a href="shop.do?category=all&sort=sellDesc"
                  class="primary-btn cart-btn">쇼핑 계속하기</a>
            </div>
            <div class="jss80999"></div>
            <!-- <a href="updateCart.do" class="primary-btn cart-btn cart-btn-right">수정</a> -->
            <div class="jss8080 jss8085" id="totalData"></div>
            <div class="jss8076">
               <br>
               <br><br> <strong>&nbsp;&nbsp;[배송 :전상품 무료배송]</strong>
            </div>
            <div class="jss8079">
               <a href="buyProducts.do" class="primary-btn cart-btn cart-btn-right">구매하기</a>
            </div>
         </div>
      </div>
   </section>
