                                 ...
                                 +"<td>"
                                    +"<div class='dropdown'>"
                                       ...
                                       +"<div class='dropdown-menu'>"
                                          +"<a class='dropdown-item' href='adminProductDetail.do?pNum="+dataList[i].pNum+"'><i class='bx bx-edit-alt me-1'></i>상품 관리</a> <a class='dropdown-item' href='javascript:void(0);'><i class='bx bx-trash me-1'></i> 삭제</a>"
                                       +"</div>"
                                   +"</div>"
                                 +"</td>"
                             +"</tr>";
