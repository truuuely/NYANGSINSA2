                     ...
                     <ul>
                        <li class="mypageli">
                           <div>
                              ...
                              <span class="mypagetext">${memberId}</span> <br>
                           </div>

                        </li><hr>

                        <li class="mypageli">
                           <div class="mypagedt">이름</div> <span class="mypagetext">${memberName}</span>
                           <br>
                        </li><hr>

                        <li class="mypageli">
                           <div class="mypagedt">고영이 이름</div> <span class="mypagetext">${memberCName}</span>
                           <br>
                        </li><hr>
                        <li class="mypageli">

                           <div class="mypagedt">이메일</div> <span class="mypagetext">${memberEmail}</span>
                           <br>
                        </li><hr>
                        <li class="mypageli">
                           <div class="mypagedt">전화번호</div> <span class="mypagetext">${memberPhone}</span>
                           <br>
                        </li><hr>
                        <li class="mypageli">
