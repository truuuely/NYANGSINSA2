...
<ul class="menu-inner py-1">
					...
					<li class="menu-item"><a href="adminIndex.do"
						class="menu-link"
					> <i class="menu-icon tf-icons bx bx-home-circle"></i>
...
<!--                            <li><a class="dropdown-item" href="#"> <i class="bx bx-user me-2"></i> <span class="align-middle">My Profile</span>
            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                  <h4 class="fw-bold py-3 mb-4">
                     <span class="text-muted fw-light">관리자 메뉴 ></span> 리뷰관리
                  </h4>

                  <!-- Hoverable Table rows -->
                  <div class="card">
                     <h5 class="card-header">리뷰목록</h5>
   ...
   <!-- Page JS -->
   <script src="js/adm_r_list.js"></script>
