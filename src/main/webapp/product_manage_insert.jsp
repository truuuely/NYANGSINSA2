		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					...
					>관리자 메뉴</span></li>
					<!-- Cards -->
					<li class="menu-item"><a href="member_manage.jsp"
						class="menu-link"
					...
					<!-- 상품관리 -->
					<li class="menu-item"><a href="product_manage.jsp"
						class="menu-link"
					...
					<!-- 주문관리 -->
					<li class="menu-item"><a href="order_manage.jsp"
						class="menu-link"
					...
					<!-- 리뷰관리 -->
					<li class="menu-item"><a href="review_manage.jsp"
						class="menu-link"
